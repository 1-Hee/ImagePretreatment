...
import com.example.imagetestapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setFragment() {
        ...
        if (inputSize.width > 0 && inputSize.height > 0 && cameraId != null) {
            // CameraFragment 생성 시, 이미지를 처리하게 하는 processImage() 함수를 전달
